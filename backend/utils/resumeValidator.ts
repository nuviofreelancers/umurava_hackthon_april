...
function isMissing(value: any): boolean {
  ...
  if (typeof value === "number" && value === 0 && value !== undefined) return false; // 0 years is valid
  return false;
}

export function validateResume(candidate: Record<string, any>): Record<string, any> {
