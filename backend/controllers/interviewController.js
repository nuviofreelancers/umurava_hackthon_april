...
exports.notifyInterview = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
// POST /api/interviews/notify
const notifyInterview = async (req, res) => {
    try {
        const { candidate_email, candidate_name, job_title, interview_date, interview_time, interview_platform, interview_link, interview_location, interview_notes } = req.body;
...
exports.notifyInterview = notifyInterview;
